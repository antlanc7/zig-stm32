...
const RCC_AHBENR: *volatile u32 = @ptrFromInt(RCC_BASE + RCC_AHBENR_OFFSET);
...
const GPIOB_MODER: *volatile u32 = @ptrFromInt(GPIOB_BASE + GPIO_MODER_OFFSET);
...
const GPIOB_ODR: *volatile u32 = @ptrFromInt(GPIOB_BASE + GPIO_ODR_OFFSET);
