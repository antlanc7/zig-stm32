pub const devices = struct {
    ...
    pub const STM32F042x = struct {
        pub const peripherals = struct {
            ...
            ///  General-purpose I/Os
            pub const GPIOB = @as(*volatile types.peripherals.GPIOF, @ptrFromInt(0x48000400));
            ///  General-purpose I/Os
            pub const GPIOC = @as(*volatile types.peripherals.GPIOF, @ptrFromInt(0x48000800));
            ///  General-purpose I/Os
            pub const GPIOF = @as(*volatile types.peripherals.GPIOF, @ptrFromInt(0x48001400));
...
pub const types = struct {
    pub const peripherals = struct {
        ...
        pub const NVIC = extern struct {
            ...
            ISER: packed struct(u32) {
                ///  SETENA
                SETENA: u32,
            },
            reserved128: [124]u8,
            ///  Interrupt Clear Enable Register
            ICER: packed struct(u32) {
                ///  CLRENA
                CLRENA: u32,
            },
            reserved256: [124]u8,
            ///  Interrupt Set-Pending Register
            ISPR: packed struct(u32) {
                ///  SETPEND
                SETPEND: u32,
            },
            reserved384: [124]u8,
            ///  Interrupt Clear-Pending Register
            ICPR: packed struct(u32) {
                ///  CLRPEND
                CLRPEND: u32,
            },
            reserved768: [380]u8,
        ...
        pub const RTC = extern struct {
            ...
            reserved36: [4]u8,
            ///  write protection register
            WPR: packed struct(u32) {
                ///  Write protection key
                KEY: u8,
                padding: u24,
            },
            ///  sub second register
            SSR: packed struct(u32) {
                ///  Sub second value
                SS: u16,
                padding: u16,
            },
            ///  shift control register
            SHIFTR: packed struct(u32) {
            ...
            TSSSR: packed struct(u32) {
                ///  Sub second value
                SS: u16,
                padding: u16,
            },
            ///  calibration register
            CALR: packed struct(u32) {
                ///  Calibration minus
                CALM: u9,
                reserved13: u4,
                ///  Reserved
            ...
            reserved80: [8]u8,
            ///  backup register
            BKP0R: packed struct(u32) {
                ///  BKP
                BKP: u32,
            },
            ///  backup register
            BKP1R: packed struct(u32) {
                ///  BKP
                BKP: u32,
            },
            ///  backup register
            BKP2R: packed struct(u32) {
                ///  BKP
                BKP: u32,
            },
            ///  backup register
            BKP3R: packed struct(u32) {
                ///  BKP
                BKP: u32,
            },
            ///  backup register
            BKP4R: packed struct(u32) {
                ///  BKP
                BKP: u32,
            },
        };
        ...
        pub const TSC = extern struct {
            ...
            IOG1CR: packed struct(u32) {
                ///  Counter value
                CNT: u14,
                padding: u18,
            },
            ///  I/O group x counter register
            IOG2CR: packed struct(u32) {
                ///  Counter value
                CNT: u14,
                padding: u18,
            },
            ///  I/O group x counter register
            IOG3CR: packed struct(u32) {
                ///  Counter value
                CNT: u14,
                padding: u18,
            },
            ///  I/O group x counter register
            IOG4CR: packed struct(u32) {
                ///  Counter value
                CNT: u14,
                padding: u18,
            },
            ///  I/O group x counter register
            IOG5CR: packed struct(u32) {
                ///  Counter value
                CNT: u14,
                padding: u18,
            },
            ///  I/O group x counter register
            IOG6CR: packed struct(u32) {
                ///  Counter value
                CNT: u14,
                padding: u18,
            },
